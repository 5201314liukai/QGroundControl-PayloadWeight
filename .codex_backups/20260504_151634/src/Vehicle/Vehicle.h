...
public:
    ...
    Q_PROPERTY(double               payloadWeight               READ payloadWeight                                                  NOTIFY payloadWeightChanged)
    Q_PROPERTY(QString              payloadWeightText           READ payloadWeightText                                              NOTIFY payloadWeightChanged)
    Q_PROPERTY(bool                 payloadWeightAvailable      READ payloadWeightAvailable                                         NOTIFY payloadWeightChanged)
    ...
    */
    ...
    double payloadWeight                () const { return _payloadWeightKg; }
    QString payloadWeightText           () const;
    bool payloadWeightAvailable         () const { return _payloadWeightAvailable; }
...
private:
    ...
    void _updatePayloadWeightFromStatusText(const QString& messageText);
    ...
    int             _updateCount = 0;
    double          _payloadWeightKg = qQNaN();
    bool            _payloadWeightAvailable = false;
    int             _rcRSSI = 255;
