if(LINUX)
	...
	add_custom_command(OUTPUT ${CMAKE_BINARY_DIR}/release/package/YingHangYuan.AppImage
	...
	add_custom_target(appimage DEPENDS ${CMAKE_BINARY_DIR}/release/package/YingHangYuan.AppImage)
...
elseif(WIN32)
	...
	# deploy
	include(Windeployqt)
	windeployqt(QGroundControl "YingHangYuan-installer.exe")
...
elseif(ANDROID)
	...
	add_qt_android_apk(QGroundControl.apk QGroundControl
		PACKAGE_NAME "io.yinghangyuan.gcs"
